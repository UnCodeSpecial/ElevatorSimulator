...
void Building::action(double arrivalsPerSecond)
{
  ...
  for (int e = 0; e < ELEVATORS; e++)
  {
    ...
    if (waitForRiders(e)) continue;
    if (startMoving(e)) continue;
  }
}

bool Building::disembarkRider(int e)
{
  // disembark if door is open and if rider is at floor
...
{
    // if door is open and elevator is not full 
...
bool Building::waitForRiders(int e) // lab 12
{
...
bool Building::startMoving(int e) // lab 12
{
